TOR SUPPORT IN pigycoin
======================

It is possible to run pigycoin as a Tor hidden service, and connect to such services.

The following directions assume you have a Tor proxy running on port 9050. Many distributions default to having a SOCKS proxy listening on port 9050, but others may not. In particular, the Tor Browser Bundle defaults to listening on port 9150. See [Tor Project FAQ:TBBSocksPort](https://www.torproject.org/docs/faq.html.en#TBBSocksPort) for how to properly
configure Tor.


1. Run pigycoin behind a Tor proxy
---------------------------------

The first step is running pigycoin behind a Tor proxy. This will already make all
...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./pigycoin -proxy=127.0.0.1:9050


2. Run a pigycoin hidden server
------------------------------
...
your pigycoind's P2P listen port (9666 by default).

	-externalip=X   You can tell pigycoin about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/pigycoin-service/hostname. Onion addresses are given
...
for normal IPv4/IPv6 communication, use:
	...
	./pigycoin -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
- Do not add anything but pigycoin ports to the hidden service created in section 2.
