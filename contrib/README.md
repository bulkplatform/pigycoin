...
Contains files used to package pigycoind/pigycoin-qt
for Debian-based Linux systems. If you compile pigycoind/pigycoin-qt yourself, there are some useful files here.
...
### [RPM](/contrib/rpm) ###
RPM spec file for building pigycoin-core on RPM based distributions
