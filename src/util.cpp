...
const char * const BITCOIN_CONF_FILENAME = "pigycoin.conf";
const char * const BITCOIN_PID_FILENAME = "pigycoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "pigycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/pigycoin";
#else
    // Unix
    return pathRet / ".pigycoin";
#endif
#endif
}
