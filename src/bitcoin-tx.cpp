...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pigycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pigycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pigycoin transaction") + "\n" +
              "  pigycoin-tx [options] -create [commands]   " + _("Create hex-encoded pigycoin transaction") + "\n" +
              "\n";
